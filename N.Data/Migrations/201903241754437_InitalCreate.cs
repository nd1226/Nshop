    ...
    public partial class InitalCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        varchar = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => new { t.PostID, t.varchar })
                .ForeignKey("dbo.Posts", t => t.PostID, cascadeDelete: true)
                .ForeignKey("dbo.Tags", t => t.varchar, cascadeDelete: true)
                .Index(t => t.PostID)
                .Index(t => t.varchar);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.ProductID, t.varchar })
                .ForeignKey("dbo.Products", t => t.ProductID, cascadeDelete: true)
                .ForeignKey("dbo.Tags", t => t.varchar, cascadeDelete: true)
                .Index(t => t.ProductID)
                .Index(t => t.varchar);
        ...
        {
            DropForeignKey("dbo.ProductTags", "varchar", "dbo.Tags");
            DropForeignKey("dbo.ProductTags", "ProductID", "dbo.Products");
            DropForeignKey("dbo.PostTags", "varchar", "dbo.Tags");
            ...
            DropIndex("dbo.ProductTags", new[] { "varchar" });
            DropIndex("dbo.ProductTags", new[] { "ProductID" });
            DropIndex("dbo.PostTags", new[] { "varchar" });
